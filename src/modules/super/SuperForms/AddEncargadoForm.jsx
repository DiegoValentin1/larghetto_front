...
export const AddEncargadoForm = ({ isOpen, cargarDatos, onClose, option }) => {
    ...
    const form = useFormik({
        ...
        onSubmit: async (values) => {
            return Alert.fire({
                ...
                preConfirm: async () => {
                    try {
                        console.log(JSON.stringify({ ...values, role: "ENCARGADO" }));
                        const response = await AxiosClient({
                            method: "POST",
                            url: "/personal/user",
                            data: JSON.stringify({ ...values, role: "ENCARGADO" }),
                        });
